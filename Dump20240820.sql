...
INSERT INTO `fornecedor_has_produto` VALUES ('2020',1),('2050',2),('2020',3),('2030',5),('2040',8);
...
INSERT INTO `marca` VALUES (1,'Caloi'),(2,'Oggi'),(3,'GTS'),(4,'Trek'),(5,'Scott'),(6,'Kona'),(7,'Specialized'),(8,'Cannondale'),(9,'Nike'),(10,'Adidas'),(11,'DITOLS'),(12,'JISICK');
...
INSERT INTO `pagamento` VALUES (4,'222',51,1,3),(3,'666',35000,12,1),(1,'999',139,1,2),(2,'999',6029,2,1);
...
INSERT INTO `pedido` VALUES (1,'2023-04-12','111'),(2,'2024-07-30','111'),(3,'2024-03-12','555'),(4,'2024-08-22','111');
...
INSERT INTO `pedidohasproduto` VALUES (1,6000,1,2),(1,51,1,4),(1,35000,2,3),(1,29,6,2),(1,139,7,1);
...
INSERT INTO `precoproduto` VALUES (1,'2024-01-01 03:00:00',6000),(2,'2024-04-10 03:00:00',35000),(3,'2024-06-14 03:00:00',22000),(4,'2024-07-20 03:00:00',18000),(5,'2024-02-15 03:00:00',51),(6,'2024-09-02 03:00:00',29),(7,'2023-03-25 03:00:00',139),(8,'2024-05-30 03:00:00',229),(9,'2022-08-08 03:00:00',79);
...
INSERT INTO `produto` VALUES (1,'Bicicleta',59,'A',1,'Strada Racing'),(2,'Bicicleta',13,'A',7,'Tarmac SL7'),(3,'Bicicleta',36,'A',8,'Synapse Carbon'),(4,'Bicicleta',27,'A',4,'Domane SL 6'),(5,'Luva de Ciclismo',10,'GG',11,'Meio Dedo '),(6,'Luva de Ciclismo',14,'G',12,'Moke Gel Meio Dedo'),(7,'Camisa Esportiva',7,'M',9,'Dri-Fit Park VII'),(8,'Camisa Esportiva',15,'P',10,'Essentials 3'),(9,'Boné Ciclismo',6,'XG',9,'Cycling Replica');
...
INSERT INTO `unidadedemedida` VALUES ('A','Aro'),('G','Tamanho das roupas '),('GG','Tamanho das roupas '),('M','Tamanho das roupas '),('P','Tamanho das roupas '),('XG','Tamanho das roupas ');
...
-- Dump completed on 2024-08-20  8:59:57
